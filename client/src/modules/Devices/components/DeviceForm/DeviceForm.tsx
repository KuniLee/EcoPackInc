    ...
    <>
      <form onSubmit={onSubmit} className="mt-2 rounded text-black flex flex-col">
        <TEInput
          ...
          <small id="idError" className="absolute w-full text-danger-700 dark:text-neutral-200">
        ...
        <TEInput
          ...
          <small id="nameError" className="absolute w-full text-danger-700 dark:text-neutral-200">
            {errors.Name?.message}
          </small>
        </TEInput>
        <TEInput
          ...
          <small id="screenError" className="absolute w-full text-danger-700 dark:text-neutral-200">
        ...
        <div className="mt-4 block min-h-[1.5rem] pl-[1.5rem]">
          <input
            ...
            defaultChecked
          />
          <label className="inline-block pl-[0.15rem] hover:cursor-pointer" htmlFor="is-requested">
            Опрос
          </label>
        </div>
